function [ueLayoutMatrix] = setUeLayout2(factorySizeVector,ueNums,seedNum)
        ...
        if bitGen == 1
            ...
            if randomX < 0 || randomX > factorySizeVector(1)
                if randomX < 0
                    ...
                    randomX = (ueLayoutMatrix(indReset,1)-1) + 2*rand(1,1);
                    randomY = signum*sqrt(1-(randomX-ueLayoutMatrix(indReset,1))^2)+ueLayoutMatrix(indReset,2);
                else
            ...
            elseif randomY < 0 || randomY > factorySizeVector(2)
                if randomY < 0
                    ...
                    randomY = (ueLayoutMatrix(indReset,2)-1) + 2*rand(1,1);
                    randomX = signum*sqrt(1-(randomY-ueLayoutMatrix(indReset,2))^2)+ueLayoutMatrix(indReset,1);
                else
