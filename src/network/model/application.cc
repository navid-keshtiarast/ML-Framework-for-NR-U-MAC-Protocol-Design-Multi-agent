...
Application::DoInitialize (void)
{
  ...
  if (m_stopTime != TimeStep (0))
    {
      std::cout << "Stop time : " << m_stopTime.GetSeconds() << std::endl;
...
void Application::SetUdpInterval (Time interval)
{ 
}

void Application::SetUdpPacketSize (uint32_t packetSize)
{ 
}

void Application::SetBurstFragmentSize (uint32_t fragmentSize)
{ 
}
