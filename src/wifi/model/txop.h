...
public:
  ...
  void SetBackoffType (uint32_t backoffType);

  void SetLinearBackoff (uint32_t backoffConst);
  /**
  ...
  uint32_t GetBackoffType (void) const;

  uint32_t GetLinearBackoff (void) const;
