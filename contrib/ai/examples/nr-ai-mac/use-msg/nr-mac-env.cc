...
NS_LOG_COMPONENT_DEFINE("nr-mac-env-msg");

NS_OBJECT_ENSURE_REGISTERED(NrMacTimeStepEnv);
...
void NrMacTimeStepEnv::ScheduleNextStateRead()
{
  ...
  Ns3AiMsgInterfaceImpl<NrMacEnv, NrMacAct>* msgInterface =
        Ns3AiMsgInterface::Get()->GetInterface<NrMacEnv, NrMacAct>();
...
uint32_t
NrMacTimeStepEnv::ChangeMacType(uint32_t macType)
{
