...
class WifiMacEnv : public OpenGymEnv
{
public:
  WifiMacEnv ();
  ~WifiMacEnv () override;
...
class WifiMacTimeStepEnv : public WifiMacEnv
{
public:
  WifiMacTimeStepEnv (uint32_t num_ap, uint32_t trafficType, std::vector<uint32_t> udpLambda, uint32_t packetSize);
  ~WifiMacTimeStepEnv() override;
