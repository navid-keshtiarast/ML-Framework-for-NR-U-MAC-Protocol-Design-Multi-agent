...
class Experiment:
    # print("Debugging ns3ai_utils Experiment")
    _created = False
    ...
    def __init__(self, targetName, ns3Path, msgModule, envNumber,
                 handleFinish=False,
        ...
        # print("Debugging ns3ai_utils Experiment __init__() with self._created : ", self._created)
        # if self._created:
        ...
        self.segName = segName + envNumber
        self.cpp2pyMsgName = cpp2pyMsgName + envNumber
        self.py2cppMsgName = py2cppMsgName + envNumber
        self.lockableName = lockableName + envNumber

        print("ns3ai_uitls Segment name : ", self.segName)
    ...
    def run(self, setting=None, show_output=False):
        # print("Debugging ns3ai_utils Experiment run()")
        self.kill()
    ...
    def kill(self):
        # print("Debugging ns3ai_utils Experiment kill()")
