  ...
  public:
          ...
          m_isFinished(false)
    {
        ...
        if (m_isCreator)
        {
            ...
            {
                // std::cout << "Debugging m_useVector false " << std::endl;
        ...
        {
            // std::cout << "Debugging m_isCreator false" << std::endl;
    ...
    {
        // std::cout << "Debugging GetCpp2PyStruct()" << std::endl;
        assert(!m_useVector);
    ...
    {
        // std::cout << "Debugging GetPy2CppStruct()" << std::endl;
        assert(!m_useVector);
    ...
    void CppSendBegin()
    {
        // std::cout << "Debug ns3-ai-msg-interface CppSendBegin()" << std::endl;
    ...
    void CppSendEnd()
    {
        // std::cout << "Debug ns3-ai-msg-interface CppSendEnd()" << std::endl;
    ...
    void CppRecvBegin()
    {
        // std::cout << "Debug ns3-ai-msg-interface CppRecvBegin()" << std::endl;
    ...
    void CppRecvEnd()
    {
        // std::cout << "Debug ns3-ai-msg-interface CppRecvEnd()" << std::endl;
    ...
    void PyRecvBegin()
    {
        // std::cout << "Debug ns3-ai-msg-interface PyRecvBegin()" << std::endl;
    ...
    void PyRecvEnd()
    {
        // std::cout << "Debug ns3-ai-msg-interface PyRecvEnd()" << std::endl;
    ...
    void PySendBegin()
    {
        // std::cout << "Debug ns3-ai-msg-interface PySendBegin()" << std::endl;
    ...
    void PySendEnd()
    {
        // std::cout << "Debug ns3-ai-msg-interface PySendEnd()" << std::endl;
...
class Ns3AiMsgInterface : public Singleton<Ns3AiMsgInterface>
{
  public:
    ...
    {
        // std::cout << "Debugging SetIsMemoryCreator()" << std::endl;
    ...
    {
        // std::cout << "Debugging SetUseVector()" << std::endl;
    ...
    {
        // std::cout << "Debugging SetHandleFinish()" << std::endl;
    ...
    {
        // std::cout << "Debugging SetMemorySize()" << std::endl;
        this->m_size = size;
    };
    ...
    {
        // std::cout << "Debugging SetNames()" << std::endl;
    ...
    {
        // std::cout << "Debugging GetInterface()" << std::endl;
